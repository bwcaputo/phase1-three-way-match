...
<header>
  <div class="container">
    ...
    <p class="one-liner">Five experiment variants. 120 invoices. Two governance frameworks. <a href="#scorecard" style="font-weight:500;">Jump to scorecard &darr;</a></p>
  </div>
</header>
...
<section id="nist">
  ...
  <p class="nist-coverage">NIST coverage: <strong>8 of 19 categories</strong> touched across four findings. Gaps cluster in organizational process areas (GOVERN 2/4/5/6) and time-series monitoring (MEASURE 3/4) &mdash; expected for a single-developer lab, and each gap maps to a Phase 2 deliverable.</p>
</section>
